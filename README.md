...
| USYC on testnet | Official contracts and live code verified; access requires Circle allowlisting (typically 24–48h), so A8 ships the disclosed mock fallback | [`docs/USYC-SWEEP.md`](docs/USYC-SWEEP.md) |
