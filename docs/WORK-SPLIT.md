...
- **A6. CI + test wiring.** Contracts' 111 tests in CI; wire AT-16/17/18 harnesses (17: second advance on prior job reverts; 18: facilitator endpoints asserted to be Circle's from V1's fixtures). *Done when:* one CI run executes contract + integration suites green. *(1d)*
